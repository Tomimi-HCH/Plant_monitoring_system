 ...
 * 函数宏定义
**********************/
#define SCL_H           HAL_GPIO_WritePin(SCL_PORT, SCL_PIN, (GPIO_PinState)1)
#define SCL_L           HAL_GPIO_WritePin(SCL_PORT, SCL_PIN, (GPIO_PinState)0)

#define SDA_H           HAL_GPIO_WritePin(SDA_PORT, SDA_PIN, (GPIO_PinState)1)
