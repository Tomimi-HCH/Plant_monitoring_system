...
| ![](00_FreeRTOS工程模板建立\1_version_migrate.png) |
| :------------------------------------------------: |
...
| <img src="00_FreeRTOS工程模板建立\2_rtos_v2.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |
...
| <img src="00_FreeRTOS工程模板建立\3_timebase_src.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |
...
| <img src="00_FreeRTOS工程模板建立\4_ide_version.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |
...
| <img src="00_FreeRTOS工程模板建立\5_use_microlib.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |
...
| <img src="00_FreeRTOS工程模板建立\6_default_task.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |

为了验证我们配置的RTOS是否能够正常运行，我们可以在freertos.c中添加测试打印(5_4工程已经实现了printf功能)：

| <img src="00_FreeRTOS工程模板建立\7_include_stdio.png" style="zoom:67%;" /> |
| :----------------------------------------------------------: |
| <img src="00_FreeRTOS工程模板建立\8_start_default_task.png" style="zoom:67%;" /> |

然后我们编译工程，烧写到开发板上看下结果：

| ![](00_FreeRTOS工程模板建立\9_result.png) |
| :---------------------------------------: |
